...
|jiaoshixingming|varchar(200)|是|NULL|教师姓名|
|dianhua|varchar(200)|是|NULL|电话|
|ketimingcheng|varchar(200)|是|NULL|课题名称|
|ketijianjie|longtext|是|NULL|课题简介|
|ketiwenjian|varchar(200)|是|NULL|课题文件|
表4.4 课题选择信息表
...
|dianhua|varchar(200)|是|NULL|电话|
|ketimingcheng|varchar(200)|是|NULL|课题名称|
|ketijianjie|varchar(200)|是|NULL|课题简介|
|ketiwenjian|varchar(200)|是|NULL|课题文件|
...
|banji|varchar(200)|是|NULL|班级|
|zhuanye|varchar(200)|是|NULL|专业|
|lunwenmingcheng|varchar(200)|是|NULL|论文名称|
|lunwenshangchuan|varchar(200)|是|NULL|论文上传|
